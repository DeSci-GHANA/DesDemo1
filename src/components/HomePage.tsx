...
const logo = new URL('../assets/DeSciNo.png', import.meta.url).href;
const sciImage = new URL('../assets/Sci.jpg', import.meta.url).href;
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-lime-600 to-cyan-600 p-8 text-white">
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-3">
            <Button 
              type="button" 
              className="bg-white text-lime-700 hover:bg-lime-50"
              onClick={() => window.open('https://chat.whatsapp.com/Fq9PmcsNqcx3vrO6eXQJaY?mode=wwt', '_blank')}
            >
              Join Our Community
            </Button>
            <Button 
              ...
              onClick={() => window.open('https://x.com/DesciGhana?t=eh_lziJSWEkyZpkmVN4Iiw&s=09', '_blank')}
            >
              Follow Us on X
            </Button>
          </div>
