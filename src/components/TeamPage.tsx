  ...
  const leadership = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1739298061740-5ed03045b280?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWFtJTIwY29sbGFib3JhdGlvbiUyMG9mZmljZXxlbnwxfHx8fDE3NjMxNzU1ODN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    },
    {
      name: 'Justice Adugdaa',
      role: 'Web Developer',
                ...
                <div className="flex-1">
                  ...
                  <CardContent>
                    ...
                    <div className="flex gap-2">
                      <Button type="button" size="sm" variant="outline" aria-label={`Connect with ${member.name} on LinkedIn`}>
                        <Linkedin className="w-4 h-4" />
                      </Button>
                      <Button type="button" size="sm" variant="outline" aria-label={`Connect with ${member.name} on Twitter`}>
                        <Twitter className="w-4 h-4" />
                      </Button>
                      <Button type="button" size="sm" variant="outline" aria-label={`Email ${member.name}`}>
